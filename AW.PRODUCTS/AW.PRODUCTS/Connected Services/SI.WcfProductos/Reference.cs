...
namespace AW.PRODUCTS.SI.WcfProductos {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="CompositeType", Namespace="http://schemas.datacontract.org/2004/07/AW.PRODUCTS.BL")]
    ...
    public interface IAWProductos {
        ...
        AW.PRODUCTS.SI.WcfProductos.CompositeType GetDataUsingDataContract(AW.PRODUCTS.SI.WcfProductos.CompositeType composite);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAWProductos/GetDataUsingDataContract", ReplyAction="http://tempuri.org/IAWProductos/GetDataUsingDataContractResponse")]
        System.Threading.Tasks.Task<AW.PRODUCTS.SI.WcfProductos.CompositeType> GetDataUsingDataContractAsync(AW.PRODUCTS.SI.WcfProductos.CompositeType composite);
        ...
        AW.PRODUCTS.MODEL.V2.Product[] ListarProductosPorRangoDePrecio(decimal precioInferior, decimal precioSuperior);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAWProductos/ListarProductosPorRangoDePrecio", ReplyAction="http://tempuri.org/IAWProductos/ListarProductosPorRangoDePrecioResponse")]
        System.Threading.Tasks.Task<AW.PRODUCTS.MODEL.V2.Product[]> ListarProductosPorRangoDePrecioAsync(decimal precioInferior, decimal precioSuperior);
        ...
        AW.PRODUCTS.MODEL.V2.Product[] ListarProductosPorColor(string elColor);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAWProductos/ListarProductosPorColor", ReplyAction="http://tempuri.org/IAWProductos/ListarProductosPorColorResponse")]
        System.Threading.Tasks.Task<AW.PRODUCTS.MODEL.V2.Product[]> ListarProductosPorColorAsync(string elColor);
        ...
        AW.PRODUCTS.MODEL.V2.Product[] ListarProductosPorNombreDeCategoria(string laCategoria);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAWProductos/ListarProductosPorNombreDeCategoria", ReplyAction="http://tempuri.org/IAWProductos/ListarProductosPorNombreDeCategoriaResponse")]
        System.Threading.Tasks.Task<AW.PRODUCTS.MODEL.V2.Product[]> ListarProductosPorNombreDeCategoriaAsync(string laCategoria);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAWProductosChannel : AW.PRODUCTS.SI.WcfProductos.IAWProductos, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AWProductosClient : System.ServiceModel.ClientBase<AW.PRODUCTS.SI.WcfProductos.IAWProductos>, AW.PRODUCTS.SI.WcfProductos.IAWProductos {
        ...
        public AW.PRODUCTS.SI.WcfProductos.CompositeType GetDataUsingDataContract(AW.PRODUCTS.SI.WcfProductos.CompositeType composite) {
            return base.Channel.GetDataUsingDataContract(composite);
        }
        
        public System.Threading.Tasks.Task<AW.PRODUCTS.SI.WcfProductos.CompositeType> GetDataUsingDataContractAsync(AW.PRODUCTS.SI.WcfProductos.CompositeType composite) {
            return base.Channel.GetDataUsingDataContractAsync(composite);
        }
        
        public AW.PRODUCTS.MODEL.V2.Product[] ListarProductosPorRangoDePrecio(decimal precioInferior, decimal precioSuperior) {
            return base.Channel.ListarProductosPorRangoDePrecio(precioInferior, precioSuperior);
        }
        
        public System.Threading.Tasks.Task<AW.PRODUCTS.MODEL.V2.Product[]> ListarProductosPorRangoDePrecioAsync(decimal precioInferior, decimal precioSuperior) {
            return base.Channel.ListarProductosPorRangoDePrecioAsync(precioInferior, precioSuperior);
        }
        
        public AW.PRODUCTS.MODEL.V2.Product[] ListarProductosPorColor(string elColor) {
            return base.Channel.ListarProductosPorColor(elColor);
        }
        
        public System.Threading.Tasks.Task<AW.PRODUCTS.MODEL.V2.Product[]> ListarProductosPorColorAsync(string elColor) {
            return base.Channel.ListarProductosPorColorAsync(elColor);
        }
        
        public AW.PRODUCTS.MODEL.V2.Product[] ListarProductosPorNombreDeCategoria(string laCategoria) {
            return base.Channel.ListarProductosPorNombreDeCategoria(laCategoria);
        }
        
        public System.Threading.Tasks.Task<AW.PRODUCTS.MODEL.V2.Product[]> ListarProductosPorNombreDeCategoriaAsync(string laCategoria) {
